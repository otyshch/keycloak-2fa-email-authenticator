...
public class ConditionalEmailAuthenticatorFormFactory
    extends EmailAuthenticatorFormFactory {

    public static final String PROVIDER_ID = "email-conditional-authenticator";
    public static final ConditionalEmailAuthenticatorForm SINGLETON =
        new ConditionalEmailAuthenticatorForm();
    ...
    public List<ProviderConfigProperty> getConfigProperties() {
        ...
        ProviderConfigProperty forceOtpUserAttribute =
        ...
        forceOtpUserAttribute.setHelpText(
        ...
        skipOtpForHttpHeader.setHelpText(
        ...
        ProviderConfigProperty forceOtpForHttpHeader =
            new ProviderConfigProperty();
        ...
        forceOtpForHttpHeader.setHelpText(
